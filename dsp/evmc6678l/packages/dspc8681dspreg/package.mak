...
override PKGDIR = dspc8681dspreg
...
package/%.xdc.inc package/%_dspc8681dspreg.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package dspc8681dspreg" (because $@ is older than $(firstword $?))" ...
...
package/rel/undefineddspc8681dspregpackage/package.rel.xml: package/package.cfg.xdc.inc
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	@$(MSG) generating schema include file list ...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js dspc8681dspreg $@
...
.PHONY: release,dspc8681dspreg
dspc8681dspreg.zip: package/package.bld.xml
dspc8681dspreg.zip: package/build.cfg
dspc8681dspreg.zip: package/package.xdc.inc
dspc8681dspreg.zip: package/package.cfg.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/dspc8681dspreg.zip.dep
endif
package/rel/dspc8681dspreg/dspc8681dspreg/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

dspc8681dspreg.zip: package/rel/dspc8681dspreg.xdc.inc package/rel/dspc8681dspreg/dspc8681dspreg/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELZIP,package/rel/dspc8681dspreg.xdc.inc,package/rel/dspc8681dspreg.zip.dep)


release release,dspc8681dspreg: all dspc8681dspreg.zip
clean:: .clean
	-$(RM) dspc8681dspreg.zip
	-$(RM) package/rel/dspc8681dspreg.xdc.inc
	-$(RM) package/rel/dspc8681dspreg.zip.dep
